...
module FinapiApi
  ...
  class BankConnectionInterface
    ...
    def self.swagger_types
      {
        :'login_credentials' => :'Array<LoginCredentialResource>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'aisConsent')
        self.ais_consent = attributes[:'aisConsent']
      end
    ...
    def valid?
      ...
      interface_validator = EnumAttributeValidator.new('String', ['WEB_SCRAPER', 'FINTS_SERVER', 'XS2A'])
    ...
    def interface=(interface)
      validator = EnumAttributeValidator.new('String', ['WEB_SCRAPER', 'FINTS_SERVER', 'XS2A'])
    ...
    def hash
      [login_credentials, two_step_procedures, default_two_step_procedure_id, last_manual_update, last_auto_update, ais_consent, interface].hash
    end
