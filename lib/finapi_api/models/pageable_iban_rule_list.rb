...
module FinapiApi
  ...
  class PageableIbanRuleList
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ibanRules')
        if (value = attributes[:'ibanRules']).is_a?(Array)
          self.iban_rules = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @iban_rules.nil?
        invalid_properties.push('invalid value for "iban_rules", iban_rules cannot be nil.')
      end
    ...
    def valid?
      return false if @iban_rules.nil?
