...
module FinapiApi
  ...
  class CheckCategorizationTransactionData
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'mcCode')
        self.mc_code = attributes[:'mcCode']
      end
    ...
    def valid?
      ...
      return false if @account_type_id > 7
      return false if @account_type_id < 1
    ...
    def account_type_id=(account_type_id)
      if account_type_id.nil?
        fail ArgumentError, 'account_type_id cannot be nil'
      end
    ...
    def hash
      [transaction_id, account_type_id, amount, purpose, counterpart, counterpart_iban, counterpart_account_number, counterpart_blz, counterpart_bic, mc_code, type_code_zka].hash
    end
