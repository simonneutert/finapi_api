...
module FinapiApi
  ...
  class KeywordRuleParams
    ...
    def valid?
      ...
      direction_validator = EnumAttributeValidator.new('String', ['Income', 'Spending', 'Both'])
    ...
    def direction=(direction)
      validator = EnumAttributeValidator.new('String', ['Income', 'Spending', 'Both'])
    ...
    def hash
      [category_id, direction, keywords].hash
    end
