...
module FinapiApi
  class MultiStepAuthentication
    ...
    attr_accessor :redirect_context

    attr_accessor :redirect_context_field
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'redirectContext')
        self.redirect_context = attributes[:'redirectContext']
      end

      if attributes.has_key?(:'redirectContextField')
        self.redirect_context_field = attributes[:'redirectContextField']
      end
    end
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('String', ['CHALLENGE_RESPONSE_REQUIRED', 'REDIRECT_REQUIRED'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['CHALLENGE_RESPONSE_REQUIRED', 'REDIRECT_REQUIRED'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          redirect_context == o.redirect_context &&
          redirect_context_field == o.redirect_context_field
    end
    ...
    def hash
      [status, redirect_url, challenge_message, answer_field_label, redirect_context, redirect_context_field].hash
    end
