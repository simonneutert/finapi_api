...
module FinapiApi
  ...
  class AccountParams
    ...
    def list_invalid_properties
      ...
      if !@account_name.nil? && @account_name !~ Regexp.new(/[A-Za-z0-9¡-ʯ &\\(\\)\\{\\}\\[\\]\\.:,;\\?!\\+\\-_\\$@#~`\\^€]*/)
        invalid_properties.push('invalid value for "account_name", must conform to the pattern /[A-Za-z0-9¡-ʯ &\\(\\)\\{\\}\\[\\]\\.:,;\\?!\\+\\-_\\$@#~`\\^€]*/.')
      end

      if !@account_type_id.nil? && @account_type_id > 7
        invalid_properties.push('invalid value for "account_type_id", must be smaller than or equal to 7.')
      end

      if !@account_type_id.nil? && @account_type_id < 1
        invalid_properties.push('invalid value for "account_type_id", must be greater than or equal to 1.')
      end
    ...
    def valid?
      return false if !@account_name.nil? && @account_name !~ Regexp.new(/[A-Za-z0-9¡-ʯ &\\(\\)\\{\\}\\[\\]\\.:,;\\?!\\+\\-_\\$@#~`\\^€]*/)
      return false if !@account_type_id.nil? && @account_type_id > 7
      return false if !@account_type_id.nil? && @account_type_id < 1
      true
    end
    ...
    def account_name=(account_name)
      if !account_name.nil? && account_name !~ Regexp.new(/[A-Za-z0-9¡-ʯ &\\(\\)\\{\\}\\[\\]\\.:,;\\?!\\+\\-_\\$@#~`\\^€]*/)
        fail ArgumentError, 'invalid value for "account_name", must conform to the pattern /[A-Za-z0-9¡-ʯ &\\(\\)\\{\\}\\[\\]\\.:,;\\?!\\+\\-_\\$@#~`\\^€]*/.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] account_type_id Value to be assigned
    def account_type_id=(account_type_id)
      if !account_type_id.nil? && account_type_id > 7
        fail ArgumentError, 'invalid value for "account_type_id", must be smaller than or equal to 7.'
      end

      if !account_type_id.nil? && account_type_id < 1
        fail ArgumentError, 'invalid value for "account_type_id", must be greater than or equal to 1.'
      end
    ...
    def hash
      [account_name, account_type_id, is_new].hash
    end
