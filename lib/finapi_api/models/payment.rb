...
module FinapiApi
  ...
  class Payment
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'bankMessage')
        self.bank_message = attributes[:'bankMessage']
      end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ['MONEY_TRANSFER', 'DIRECT_DEBIT'])
      return false unless type_validator.valid?(@type)
      return false if @status.nil?
      status_validator = EnumAttributeValidator.new('String', ['PENDING', 'SUCCESSFUL', 'NOT_SUCCESSFUL', 'DISCARDED'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['MONEY_TRANSFER', 'DIRECT_DEBIT'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['PENDING', 'SUCCESSFUL', 'NOT_SUCCESSFUL', 'DISCARDED'])
    ...
    def hash
      [id, account_id, request_date, execution_date, type, status, bank_message, amount, order_count].hash
    end
