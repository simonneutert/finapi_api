...
module FinapiApiClient
  class MocksAndTestsApi
    ...
    def check_categorization(body, opts = {})
      data, _status_code, _headers = check_categorization_with_http_info(body, opts)
      data
    end
    ...
    # @param body Transactions data
    # @param [Hash] opts the optional parameters
    # @return [Array<(CategorizationCheckResults, Fixnum, Hash)>] CategorizationCheckResults data, response status code and response headers
    def check_categorization_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MocksAndTestsApi.check_categorization ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling MocksAndTestsApi.check_categorization"
      end
      # resource path
      local_var_path = '/api/v1/tests/checkCategorization'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'CategorizationCheckResults')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MocksAndTestsApi#check_categorization\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def mock_batch_update(body, opts = {})
      mock_batch_update_with_http_info(body, opts)
      nil
    end
    ...
    def mock_batch_update_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MocksAndTestsApi.mock_batch_update ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling MocksAndTestsApi.mock_batch_update"
      end
      # resource path
      local_var_path = '/api/v1/tests/mockBatchUpdate'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MocksAndTestsApi#mock_batch_update\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
