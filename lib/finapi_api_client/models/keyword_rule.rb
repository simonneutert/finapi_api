...
module FinapiApiClient
  ...
  class KeywordRule
    ...
    def valid?
      ...
      direction_validator = EnumAttributeValidator.new('String', ['Income', 'Spending'])
    ...
    def direction=(direction)
      validator = EnumAttributeValidator.new('String', ['Income', 'Spending'])
    ...
    def hash
      [id, category, direction, creation_date, keywords].hash
    end
