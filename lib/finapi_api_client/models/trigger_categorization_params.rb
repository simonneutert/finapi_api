...
module FinapiApiClient
  ...
  class TriggerCategorizationParams
    ...
    attr_accessor :bank_connection_ids
    ...
    def self.swagger_types
      {
        :'bank_connection_ids' => :'Array<Integer>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'bankConnectionIds')
        if (value = attributes[:'bankConnectionIds']).is_a?(Array)
          self.bank_connection_ids = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          bank_connection_ids == o.bank_connection_ids
    end
