...
module FinapiApiClient
  ...
  class UpdateResult
    ...
    def valid?
      ...
      result_validator = EnumAttributeValidator.new('String', ['OK', 'BANK_SERVER_REJECTION', 'INTERNAL_SERVER_ERROR'])
      return false unless result_validator.valid?(@result)
      error_type_validator = EnumAttributeValidator.new('String', ['BUSINESS', 'TECHNICAL'])
    ...
    def result=(result)
      validator = EnumAttributeValidator.new('String', ['OK', 'BANK_SERVER_REJECTION', 'INTERNAL_SERVER_ERROR'])
    ...
    def hash
      [result, error_message, error_type, timestamp].hash
    end
