...
module FinapiApiClient
  ...
  class DailyBalanceList
    ...
    attr_accessor :latest_common_balance_timestamp

    # List of daily balances for the requested period and account(s)
    attr_accessor :daily_balances
    ...
    def self.swagger_types
      {
        ...
        :'daily_balances' => :'Array<DailyBalance>',
        :'paging' => :'Paging'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'latestCommonBalanceTimestamp')
        self.latest_common_balance_timestamp = attributes[:'latestCommonBalanceTimestamp']
      end

      if attributes.has_key?(:'dailyBalances')
        if (value = attributes[:'dailyBalances']).is_a?(Array)
          self.daily_balances = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @daily_balances.nil?
        invalid_properties.push('invalid value for "daily_balances", daily_balances cannot be nil.')
      end
    ...
    def valid?
      return false if @daily_balances.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          latest_common_balance_timestamp == o.latest_common_balance_timestamp &&
          daily_balances == o.daily_balances &&
          paging == o.paging
    end
    ...
    def hash
      [latest_common_balance_timestamp, daily_balances, paging].hash
    end
