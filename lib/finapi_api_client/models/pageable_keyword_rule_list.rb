...
module FinapiApiClient
  ...
  class PageableKeywordRuleList
    ...
    def self.swagger_types
      {
        :'keyword_rules' => :'Array<KeywordRule>',
        :'paging' => :'Paging'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'keywordRules')
        if (value = attributes[:'keywordRules']).is_a?(Array)
          self.keyword_rules = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @keyword_rules.nil?
        invalid_properties.push('invalid value for "keyword_rules", keyword_rules cannot be nil.')
      end
    ...
    def valid?
      return false if @keyword_rules.nil?
