...
module FinapiApiClient
  ...
  class ErrorMessage
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'authContext')
        self.auth_context = attributes[:'authContext']
      end
    ...
    def list_invalid_properties
      ...
      if @auth_context.nil?
        invalid_properties.push('invalid value for "auth_context", auth_context cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @auth_context.nil?
      true
    end
    ...
    def hash
      [errors, date, request_id, endpoint, auth_context, bank].hash
    end
