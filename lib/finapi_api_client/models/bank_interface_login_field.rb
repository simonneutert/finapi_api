...
module FinapiApiClient
  ...
  class BankInterfaceLoginField
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'isSecret')
        self.is_secret = attributes[:'isSecret']
      end

      if attributes.has_key?(:'isVolatile')
        self.is_volatile = attributes[:'isVolatile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @is_volatile.nil?
        invalid_properties.push('invalid value for "is_volatile", is_volatile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @is_volatile.nil?
      true
    end
    ...
    def hash
      [label, is_secret, is_volatile].hash
    end
