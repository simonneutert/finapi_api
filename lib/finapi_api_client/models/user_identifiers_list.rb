...
module FinapiApiClient
  ...
  class UserIdentifiersList
    ...
    attr_accessor :non_deleted_users
    ...
    def self.swagger_types
      {
        ...
        :'non_deleted_users' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'deletedUsers')
        if (value = attributes[:'deletedUsers']).is_a?(Array)
          self.deleted_users = value
        end
      end

      if attributes.has_key?(:'nonDeletedUsers')
        if (value = attributes[:'nonDeletedUsers']).is_a?(Array)
          self.non_deleted_users = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @non_deleted_users.nil?
        invalid_properties.push('invalid value for "non_deleted_users", non_deleted_users cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @non_deleted_users.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          non_deleted_users == o.non_deleted_users
    end
    ...
    def hash
      [deleted_users, non_deleted_users].hash
    end
