...
# Unit tests for FinapiApiClient::NotificationRule
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NotificationRule' do
  before do
    # run before each test
    @instance = FinapiApiClient::NotificationRule.new
  end
  ...
  describe 'test an instance of NotificationRule' do
    it 'should create an instance of NotificationRule' do
      expect(@instance).to be_instance_of(FinapiApiClient::NotificationRule)
    end
  end
