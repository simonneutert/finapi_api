...
# Unit tests for FinapiApiClient::IdentifierList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IdentifierList' do
  before do
    # run before each test
    @instance = FinapiApiClient::IdentifierList.new
  end
  ...
  describe 'test an instance of IdentifierList' do
    it 'should create an instance of IdentifierList' do
      expect(@instance).to be_instance_of(FinapiApiClient::IdentifierList)
    end
  end
