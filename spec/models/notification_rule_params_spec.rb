...
# Unit tests for FinapiApi::NotificationRuleParams
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NotificationRuleParams' do
  before do
    # run before each test
    @instance = FinapiApi::NotificationRuleParams.new
  end
  ...
  describe 'test an instance of NotificationRuleParams' do
    it 'should create an instance of NotificationRuleParams' do
      expect(@instance).to be_instance_of(FinapiApi::NotificationRuleParams)
    end
  end
