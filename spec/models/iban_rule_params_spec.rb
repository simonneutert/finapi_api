...
# Unit tests for FinapiApiClient::IbanRuleParams
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IbanRuleParams' do
  before do
    # run before each test
    @instance = FinapiApiClient::IbanRuleParams.new
  end
  ...
  describe 'test an instance of IbanRuleParams' do
    it 'should create an instance of IbanRuleParams' do
      expect(@instance).to be_instance_of(FinapiApiClient::IbanRuleParams)
    end
  end
