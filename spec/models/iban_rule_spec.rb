...
# Unit tests for FinapiApiClient::IbanRule
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IbanRule' do
  before do
    # run before each test
    @instance = FinapiApiClient::IbanRule.new
  end
  ...
  describe 'test an instance of IbanRule' do
    it 'should create an instance of IbanRule' do
      expect(@instance).to be_instance_of(FinapiApiClient::IbanRule)
    end
  end
