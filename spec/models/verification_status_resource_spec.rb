...
# Unit tests for FinapiApiClient::VerificationStatusResource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VerificationStatusResource' do
  before do
    # run before each test
    @instance = FinapiApiClient::VerificationStatusResource.new
  end
  ...
  describe 'test an instance of VerificationStatusResource' do
    it 'should create an instance of VerificationStatusResource' do
      expect(@instance).to be_instance_of(FinapiApiClient::VerificationStatusResource)
    end
  end
