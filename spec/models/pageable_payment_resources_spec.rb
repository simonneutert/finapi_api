...
# Unit tests for FinapiApi::PageablePaymentResources
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PageablePaymentResources' do
  before do
    # run before each test
    @instance = FinapiApi::PageablePaymentResources.new
  end
  ...
  describe 'test an instance of PageablePaymentResources' do
    it 'should create an instance of PageablePaymentResources' do
      expect(@instance).to be_instance_of(FinapiApi::PageablePaymentResources)
    end
  end
