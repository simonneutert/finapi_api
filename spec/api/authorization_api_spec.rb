...
# Unit tests for FinapiApiClient::AuthorizationApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AuthorizationApi' do
  before do
    # run before each test
    @instance = FinapiApiClient::AuthorizationApi.new
  end
  ...
  describe 'test an instance of AuthorizationApi' do
    it 'should create an instance of AuthorizationApi' do
      expect(@instance).to be_instance_of(FinapiApiClient::AuthorizationApi)
    end
  end
