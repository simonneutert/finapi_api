...
# Unit tests for FinapiApi::NotificationRulesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NotificationRulesApi' do
  before do
    # run before each test
    @instance = FinapiApi::NotificationRulesApi.new
  end
  ...
  describe 'test an instance of NotificationRulesApi' do
    it 'should create an instance of NotificationRulesApi' do
      expect(@instance).to be_instance_of(FinapiApi::NotificationRulesApi)
    end
  end
