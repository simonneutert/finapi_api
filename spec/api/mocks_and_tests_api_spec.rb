...
# Unit tests for FinapiApiClient::MocksAndTestsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MocksAndTestsApi' do
  before do
    # run before each test
    @instance = FinapiApiClient::MocksAndTestsApi.new
  end
  ...
  describe 'test an instance of MocksAndTestsApi' do
    it 'should create an instance of MocksAndTestsApi' do
      expect(@instance).to be_instance_of(FinapiApiClient::MocksAndTestsApi)
    end
  end
