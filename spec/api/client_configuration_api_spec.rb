...
# Unit tests for FinapiApiClient::ClientConfigurationApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ClientConfigurationApi' do
  before do
    # run before each test
    @instance = FinapiApiClient::ClientConfigurationApi.new
  end
  ...
  describe 'test an instance of ClientConfigurationApi' do
    it 'should create an instance of ClientConfigurationApi' do
      expect(@instance).to be_instance_of(FinapiApiClient::ClientConfigurationApi)
    end
  end
